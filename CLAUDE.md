...
backend/             Python package — contract layer, security boundary, ingestion
  ...
  tests/             1336 tests; conftest.py blocks the network suite-wide
...
frontend/            React scaffold — renders a fixture; no backend call yet
  ...
  src/
    ...
    store/           graphStore.ts
.claude/             Local Claude Code permissions and launch config (not source)
```
